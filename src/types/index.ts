...
export const calendarSettingsSchema = z.object({
  ...
  microsoft: z.object({
    ...
    tenant: z.string().trim().min(1).default('common'),
...
export const microsoftCalendarStateSchema = z.object({
...
export const calendarStateSchema = z.object({
  ...
  microsoft: microsoftCalendarStateSchema.default({}),
});
...
export type MicrosoftCalendarSettings = z.infer<typeof calendarSettingsSchema>['microsoft'];
export type MicrosoftCalendarState = z.infer<typeof microsoftCalendarStateSchema>;
