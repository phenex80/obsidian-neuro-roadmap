...
2. Give it a mapped subject property, such as `subject: ISKB02` or `course: ISKB02`.
...
Tasks without usable dates remain in **Unscheduled** until you plan them. A note with `type: roadmap` is a valid roadmap anchor, not automatically a template.
